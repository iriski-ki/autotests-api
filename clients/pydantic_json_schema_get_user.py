...
def validate_json_schema(instance: dict | list, schema: dict) -> None:
    """
    Функция валидирует JSON тела ответа согласно ожидаемой JSON схеме.

    :param instance: JSON тело ответа.
    :param schema: JSON схема, с которой нужно свериться.
