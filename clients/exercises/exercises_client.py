...
from clients.exercises.exercises_schema import ExerciseSchema, CreateExerciseResponseSchema, \
    CreateExerciseRequestSchema, GetExerciseResponseSchema, GetExercisesQuerySchema, GetExercisesResponseSchema,UpdateExerciseRequestSchema
...
class ExercisesClient(APIClient):
    ...
    def update_exercise(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        response = self.get_exercise_api(exercise_id)
        return GetExerciseResponseSchema.model_validate_json(response.text)
